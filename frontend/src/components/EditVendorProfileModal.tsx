...
export default function EditVendorProfileModal({ vendorId, profile, onClose, onSuccess }: EditVendorProfileModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Updating vendor profile with:', updateData);
      const updatedProfile = await api.updateVendorProfile(vendorId, updateData);
      console.log('Vendor profile updated successfully:', updatedProfile);
